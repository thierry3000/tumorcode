...
void GlucoseParams::assign(const ptree &pt)
{
...
void GlucoseParams::update_ptree(ptree &dst, const ptree &src)
{
...
ptree GlucoseParams::as_ptree() const
{
  ptree pt;
